...
<div class="<?php get_current_product_category();?>">
    <div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
        <div class="ast-row product-row">
            ...
            <div class="ast-col-md-5 ast-col-md-push-7 sticky-col-t-0">
                <?php
		/**
		...
		?>
            ...
            <div
                class="ast-col-md-5 ast-col-md-pull-6 t-product-info-short flex-col-start text-align-left sticky-col-t-20">
